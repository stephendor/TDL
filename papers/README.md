...
|---|---|---|---|---|
| **P01** | Persistent Homology of UK Socioeconomic Trajectories | in-progress | 0 | *Sociological Methodology* |
| **P02** | Mapper for Interior Trajectory Structure | in-progress | 1 | *Sociological Methods & Research* |
| **P03** | Zigzag Persistence and Business Cycle Topology | in-progress | 1 | *Sociological Methods & Research* |
| P04 | Multi-Parameter PH for Poverty Trap Detection | idea | 2 | *JASA Applications* |
...
**Status vocabulary:** `idea` → `in-progress` → `submitted` → `under-review` → `published`
...
Stage 1 (Months 3–12):  P02 (Mapper) + P03 (Zigzag) in parallel
Stage 2 (Months 12–24): P04–P06 (spatial, comparative, intergenerational)
