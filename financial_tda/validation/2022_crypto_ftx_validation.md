# 2022 Crypto Winter Validation: FTX Collapse

## Executive Summary

This report validates the TDA crisis detection system on the FTX Collapse using Bitcoin (BTC-USD) data.
...
**Results**:
- **Lead Time**: 428 days (✓ PASS, target ≥5 days)
- **Precision**: 0.000
- **Recall**: 0.000
- **F1 Score**: 0.000 (✗ FAIL, target ≥0.70)
- **Total Detections**: 26 (26 pre-crisis)
...
- **Crisis Event**: FTX Collapse (2022-11-11)
...
|--------|-------|--------|--------|
| Lead Time | 428 days | ≥5 days | ✓ PASS |
| Precision | 0.000 | - | - |
| Recall | 0.000 | - | - |
| F1 Score | 0.000 | ≥0.70 | ✗ FAIL |

### Detection Timeline
- **First Detection**: 428 days before crisis
- **Total Detections**: 26
- **Pre-Crisis Detections**: 26
...
- **Event Nature**: FTX Collapse represents protocol/exchange failure rather than market-wide contagion
...
- `2022_crypto_ftx_validation.png`: Timeline of prices and bottleneck distances with crisis events

---

## Conclusion

✗ FAIL: The TDA crisis detection system does not meet success criteria for FTX Collapse.
...
- Lead time of 428 days provides valuable early warning capability
